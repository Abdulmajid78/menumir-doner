    ...
    >
      ...
      <div className="bg-black bg-opacity-50 backdrop-blur-sm border-b border-gray-700 p-3 md:p-3">
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          <h1 className="text-white font-bold text-md md:text-lg">Mir Doner</h1>

          {/* Zoom Controls */}
          <div className="flex items-center space-x-1 md:space-x-2">
            <button onClick={zoomOut} className="p-1.5 md:p-2 bg-gray-700 text-gray-300 rounded-lg hover:bg-gray-600">
              <ZoomOut className="w-3 h-3 md:w-4 md:h-4" />
            </button>
            <span className="text-gray-300 text-xs md:text-sm px-1 md:px-2">
              {Math.round(zoom * 100)}%
            </span>
            <button onClick={zoomIn} className="p-1.5 md:p-2 bg-gray-700 text-gray-300 rounded-lg hover:bg-gray-600">
              <ZoomIn className="w-3 h-3 md:w-4 md:h-4" />
            </button>
            <button onClick={resetZoom} className="p-1.5 md:p-2 bg-gray-700 text-gray-300 rounded-lg hover:bg-gray-600">
